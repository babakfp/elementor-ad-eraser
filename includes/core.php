...
require_once Elementor_Ad_Eraser_Globals::dir() . "includes/is-gutenberg-active.php";
...
if ( !class_exists( "Elementor_Ad_Eraser" ) )
{
    final class Elementor_Ad_Eraser
    {
        public function __construct() {
            ...
            //         wp_enqueue_style( "elementor-ad-eraser-admin-ui", Elementor_Ad_Eraser_Globals::url() . "static/css/admin-ui.css", [], Elementor_Ad_Eraser_Globals::$version );
            //     }
            // } );
